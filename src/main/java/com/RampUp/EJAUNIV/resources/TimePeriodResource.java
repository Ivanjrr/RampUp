...
public class TimePeriodResource {
	...
	@PostMapping
	public ResponseEntity<TimePeriod> insert(@RequestBody TimePeriod obj) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<TimePeriod> update(@PathVariable Integer id, @RequestBody TimePeriod obj){
